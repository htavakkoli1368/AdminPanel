<template>
  <q-page class="q-pa-md">
    <div class="text-h5 text-center q-mb-lg">ثبت و مشاهده مصرف برق</div>
...
const columns = [
  ...
  { name: 'amount', label: 'مقدار (کیلووات)', field: 'amount', align: 'center' }
]
...
function addRecord() {
  if (amount.value && date.value) {
    ...
    localStorage.setItem('electricityRecords', JSON.stringify(records.value))
    amount.value = ''
    date.value = ''
  }
}
