<template>
  <q-page class="q-pa-md">
    <div class="text-h5 text-center q-mb-lg">Record Water Consumption</div>
...
// هنگام بارگذاری صفحه، داده‌ها را از localStorage بخوان
onMounted(() => {
...
function addRecord() {
  if (amount.value && date.value) {
    ...
    localStorage.setItem('waterRecords', JSON.stringify(records.value))
    amount.value = ''
    date.value = ''
  }
}
